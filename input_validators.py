...
NOTE: This file is named input_validators.py (not validators.py) to avoid
conflict with the Python 'validators' package on Streamlit Cloud.
"""
import re
import html
...
def validate_image_file(file_bytes: bytes, filename: str) -> bool:
    ...
    Note: Magic bytes checking without python-magic library.
    Validation uses file extension, size, and basic signature checks.
